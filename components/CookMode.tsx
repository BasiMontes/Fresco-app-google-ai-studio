...
export const CookMode: React.FC<CookModeProps> = ({ recipe, pantry, onClose, onFinish }) => {
  ...
  const [voiceEnabled, setVoiceEnabled] = useState(FEATURES.VOICE_ASSISTANT);
                              ...
                              <div className="flex items-center justify-between mb-2">
                                  <div className="flex items-center gap-3 flex-1">
                                      <button 
                                        ...
                                        className={`w-6 h-6 rounded-lg flex items-center justify-center border-2 ${ing.used ? 'bg-green-50 border-green-500' : 'border-white/30'}`}
                                      >
