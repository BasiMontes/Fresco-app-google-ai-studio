  ...
  return (
    <div className="fixed inset-0 z-[2000] bg-white animate-slide-up overflow-y-auto no-scrollbar pb-40 bg-[#FDFDFD]">
        ...
        <div className="max-w-4xl mx-auto px-6 md:px-0">
            ...
            <div className="bg-teal-900 rounded-[2rem] p-4 text-white grid grid-cols-3 gap-2 shadow-2xl -mt-6 relative z-20 mb-8">
            ...
            {/* Tab System */}
            <div className="flex p-1 bg-gray-100 rounded-[1.5rem] mb-8 border border-gray-200">
                <button 
        ...
        <div className="fixed bottom-0 left-0 right-0 p-4 bg-white/90 backdrop-blur-xl border-t border-gray-100 z-40 safe-pb animate-slide-up">
